...
function displayPics(){
  ...
  // RESPONSE: var is a global variable and it can be access anywhere. But let only works in the scope of the block block. The variable rando was declared inside the while-loop. That is why there was an error.
  console.log(viewed);
